...
In 15 modules wordt je klaargestoomd om zelf dingen te bedenken en te maken.
 ...
 <table border="1">
  <tr>
    ...
    <th>Onderwerp</th>
    <th>Lesgever</th>
    <th>Omschrijving les</th>
  </tr>
  <tr>
    <td>4 maart 2020</td>
    <td>Intro in FabZero en Github</td>
    <td>Amy Beaulisch & Benny Malengier</td>
    <td>
  ...
  <tr>
    <td>11 maart 2020</td>
    <td>2D ontwerpen en lasersnijden</td>
    <td>Amy Beaulisch</td>
    <td>
    ...
    <tr>
    <td>18 maart 2020</td>
    <td>3D ontwerpen en 3D printen</td>
    <td>Amy Beaulisch</td>
    <td>
   ...
   <tr>
    ...
    <td>Artificiële intelligentie (AI)</td>
    <td>Enrico Miglino</td>
    <td>
    ...
    <td>Wildcard</td>
    <td>Amy Beaulisch</td>
    <td>Iedereen heeft soms wel eens iets dat je graag zou leren, maar dat niet aan bod komt in de les. Daarom gaan we tijdens de sessies op zoek naar wat jij wilt leren en krijg je in deze les de tijd om het te leren. </td>
  </tr>
    <tr>
    <td><strong>Zaterdag</strong> 6 juni 2020</td>
    <td>Internet of Things (IOT)</td>
    <td>Hans Caluwaerts</td>
    <td>
    ...
    <tr>
    <td>10 juni 2020</td>
    <td>Digitaal borduren en smart textile</td>
    <td>Amy Beaulisch & Benny Malengier</td>
    <td>
    ...
    <td>17 juni 2020</td>
    <td>Project week</td>
    <td>Amy Beaulisch & gast docenten</td>
    <td>De deelnemers krijgen tijd om aan hun eind project te werken.</td>
  </tr>
      <tr>
    <td>24 juni 2020</td>
    <td>Eind project voorstelling</td>
    <td>Docenten team, vrienden en familie</td>
    <td>De deelnemers werkten tijdens de modules naar een eindproject toe. De deelnemers presenteren hun projecten voor de medestudenten en een jury. Op het einde mag dit project integraal deel uit maken van onder andere hun portfolio en motivatie voor de FabAcademy 2020. 
</td>
  </tr>  
</table>
...
Het FabZero traject gaat door op <strong>woensdag avonden</strong> van <strong>18 - 22u</strong> in de <strong>Ingegno MakerSpace</strong> te Drongen. <italic>Indien de les op een zaterdag valt, gaat deze door van 9 tot 17u.</italic>
